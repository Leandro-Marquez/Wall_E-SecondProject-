...
class Assistant
{
    public static object EvaluateSpawn(List<ASTNode> Params)
    {
        ...
        if(Params.Count != 2) Error.errors.Add((ErrorType.Run_Time_Error,"There is no argument given that corresponds to the required parameter of Spawn()"));
        else 
        {
    ...
    public static object EvaluateColor(List<ASTNode> Params)
    {
        ...
        if(Params.Count != 1) Error.errors.Add((ErrorType.Run_Time_Error,"There is no argument given that corresponds to the required parameter of Color()"));
        else
        {
    ...
    public static object EvaluateDrawLine(List<ASTNode> Params)
    {
        ...
        if (Params.Count != 3) Error.errors.Add((ErrorType.Run_Time_Error, "There is no argument given that corresponds to the required parameter of DrawLine()"));
        List<int> ints = new List<int>();
        for (var i = 0; i < Params.Count; i++)
        {
            var a = Params[i].Evaluate(false);
    ...
    public static object EvaluateSize(List<ASTNode> Params)
    {
        ...
        if(Params.Count != 1) Error.errors.Add((ErrorType.Run_Time_Error,"There is no argument given that corresponds to the required parameter of Size()"));
        else
        {
            var a = Params[0].Evaluate(false);
            if(a is int)
    ...
    public static object EvaluateIsBrushSize(List<ASTNode> Params)
    {
        ...
        if(Params.Count != 1) Error.errors.Add((ErrorType.Run_Time_Error,"There is no argument given that corresponds to the required parameter of IsBrushSize()"));
        else
        {
            var a = Params[0].Evaluate(false);
            if(a is int)
    ...
    public static object EvaluateIsBrushColor(List<ASTNode> Params)
    {
        ...
        bool ret = false;
        if(Params.Count != 1) Error.errors.Add((ErrorType.Run_Time_Error,"There is no argument given that corresponds to the required parameter of IsBrushColor()"));
        else
        {
            var a = Params[0].Evaluate(false);
            if(a is string)
    ...
    public static object EvaluateFill(List<ASTNode> Params)
    {
        ...
        if(Params.Count != 0) Error.errors.Add((ErrorType.Run_Time_Error,"Fill's Method does not contains params"));
        else
        {
    ...
    public static object EvaluateGetColorCount(List<ASTNode> Params)
    {
        ...
        if(Params.Count != 5) Error.errors.Add((ErrorType.Run_Time_Error,"There is no argument given that corresponds to the required parameter of GetColorCount()"));
        else
        {
    ...
    public static object EvaluateIsCanvasColor(List<ASTNode> Params)
    {
        ...
        if(Params.Count != 3) Error.errors.Add((ErrorType.Run_Time_Error,"There is no argument given that corresponds to the required parameter of IsCanvasColor()"));
        else
        {
            var color = Params[0].Evaluate(false);
    ...
    public static object EvaluateDrawCircle(List<ASTNode> Params)
    {
        ...
        if(Params.Count != 3) Error.errors.Add((ErrorType.Run_Time_Error,"There is no argument given that corresponds to the required parameter of DrawCircle()"));
        else
        {
    ...
    public static object EvaluateDrawRectangle(List<ASTNode> Params)
    {
        ...
        if(Params.Count != 5) Error.errors.Add((ErrorType.Run_Time_Error,"There is no argument given that corresponds to the required parameter of DrawRectangule()"));
        else
        {
